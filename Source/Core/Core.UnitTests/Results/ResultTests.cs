...
public class ResultTests {
    ...
    [Fact]
    public void AddOperator_FromSuccess_WithError_ReturnsFailure() {
        // Arrange
    ...
    [Fact]
    public void AddOperator_FromSuccess_WithCollection_ReturnsFailure() {
        // Arrange
        var result = Result.Success();
    ...
    public void ImplicitConversion_WithValue_FromValidationError_ReturnsFailure() {
        // Act
        Result<string> result = new Error("Some error.", nameof(result));
    ...
    public void ImplicitConversion_WithValue_FromValidationErrorArray_ReturnsFailure() {
        // Act
        Result<string> result = new[] { new Error("Some error.", nameof(result)) };
    ...
    public void ImplicitConversion_WithValue_FromValidationErrorList_ReturnsFailure() {
        // Act
        Result<string> result = new List<Error> { new("Some error.", nameof(result)) };
    ...
    public void ImplicitConversion_WithValue_FromValidationErrorSet_ReturnsFailure() {
        // Act
        Result<string> result = new HashSet<Error> { new("Some error.", nameof(result)) };
    ...
    public void EnsureIsSuccess_WhenResultHasErrors_ThrowsValidationException() {
        // Arrange
        var result = _invalidWithValue;

        // Act & Assert
        var action = result.EnsureIsSuccess;

        action.Should().Throw<ResultException>().WithMessage("Operation failed.");
    }
