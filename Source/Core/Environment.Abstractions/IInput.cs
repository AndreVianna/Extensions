...
public interface IInput {
    ...
    ITextPromptBuilder BuildTextPrompt(string prompt);
    ILinePromptBuilder<TValue> BuildInlinePrompt<TValue>(string prompt);
    ISelectionPromptBuilder BuildSelectionPrompt(string prompt);
    ISelectionPromptBuilder<TValue> BuildSelectionPrompt<TValue>(string prompt, Func<TValue, object> selectKey);
    ISelectionPromptBuilder<TValue, TKey> BuildSelectionPrompt<TValue, TKey>(string prompt, Func<TValue, TKey> selectKey)
        where TKey : notnull;
